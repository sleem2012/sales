...
class CustomSearchable extends StatefulWidget {
  ...
  @override
  _CustomSearchableState createState() => _CustomSearchableState();
}

class _CustomSearchableState extends State<CustomSearchable> with WidgetsBindingObserver, TickerProviderStateMixin {
                          ...
                          : Expanded(
                              ...
                              style: widget.labelStyle != null
                                  ? widget.labelStyle!.copyWith(
                                      color: onSelectLabel == '' ? Theme.of(context).brightness == Brightness.light ?Colors.black : Colors.white : null,
                                    )
                                  : TextStyle(
                                      color: onSelectLabel == '' ? Colors.grey[600] :Theme.of(context).brightness == Brightness.light ?Colors.black : Colors.white,
                                    ),
                            ),),
                      Visibility(
      ...
      child: Container(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return TextButton(
                style: TextButton.styleFrom(
                    foregroundColor: widget.primaryColor ?? Colors.black, padding: const EdgeInsets.all(8), tapTargetSize: MaterialTapTargetSize.shrinkWrap,),
                child: Padding(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: widget.dropdownItemStyle ?? TextStyle(color: KColors.of(context).accentColor),
                        ),
                      ),
                    ],
                  ),
