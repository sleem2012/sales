class CommissionModel {
  ...
  String? status;
  String? message;
  List<CommisoinData>? data;
  General? general;

  CommissionModel(
      {this.success, this.status, this.message, this.data, this.general,});
  ...
  CommissionModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <CommisoinData>[];
      json['data'].forEach((v) {
        data!.add(CommisoinData.fromJson(v));
      });
    }
    general =
...
class CommisoinData {
  ...
  CommisoinData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
    type = json['type'];
...
class General {
  ...
  General({this.pending, this.inProgress, this.completed, this.canceled});
  ...
  General.fromJson(Map<String, dynamic> json) {
    ...
    inProgress = json['in_progress'] != null
        ? Pending.fromJson(json['in_progress'])
        : null;
    completed = json['completed'] != null
        ? Pending.fromJson(json['completed'])
        : null;
    canceled = json['canceled'] != null
        ? Pending.fromJson(json['canceled'])
        : null;
  }
