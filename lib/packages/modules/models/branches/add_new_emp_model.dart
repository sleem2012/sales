...
class AddBranchManModel {
  ...
  factory AddBranchManModel.fromMap(Map<String, dynamic> map) {
    return AddBranchManModel(
  ...
  factory AddBranchManModel.fromJson(String source) => AddBranchManModel.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  @override
  bool operator ==(covariant AddBranchManModel other) {
